...
class DocumentImeInputClient extends TextInputConnectionDecorator with TextInputClient, DeltaTextInputClient {
  ...
  void updateEditingValueWithDeltas(List<TextEditingDelta> textEditingDeltas) {
    ...
    final allowedDeltas =
        _allowNonTextDeltas ? textEditingDeltas : textEditingDeltas.where((e) => e is! TextEditingDeltaNonTextUpdate).toList();
  ...
  void _sendDocumentToIme() {
    ...
    editorImeLog.fine("[DocumentImeInputClient] - Adding invisible characters?: ${imeSerialization.didPrependPlaceholder}");
