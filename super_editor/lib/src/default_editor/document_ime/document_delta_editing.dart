...
class TextDeltasDocumentEditor {
  ...
  void applyDeltas(List<TextEditingDelta> textEditingDeltas) {
    ...
    for (final delta in textEditingDeltas) {
      ...
      final execution = editor.rules.apply(editor, editor.context.find<DocumentComposer>('composer'), delta);
    ...
    editorImeLog.fine("Serializing the latest document and selection to use to compute final document composing region.");
